...
export default function Features() {
  ...
  return (
    <section id="features" className="container-narrow py-20">
      <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-center">Why ByteVerse</h2>
      <p className="mt-3 text-center text-white/70 max-w-3xl mx-auto">Discover the core features that make ByteVerse the future of AI-powered learning design.</p>
