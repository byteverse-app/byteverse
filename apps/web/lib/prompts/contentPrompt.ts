...
import { MICROLEARNING_SYSTEM_PREFIX, MICROLEARNING_STRUCTURE } from './microlearningPrompt';
...
You are creating content for Stage ${stage.id} of a microlearning course.
